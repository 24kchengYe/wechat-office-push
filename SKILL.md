...
**责任编辑** defaults to **[责任编辑待配置]**, no need to ask unless the user specifies otherwise.
...
Using the verified metadata, legacy-agent should:
